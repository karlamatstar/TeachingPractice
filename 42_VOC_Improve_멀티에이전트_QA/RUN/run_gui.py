...
class App(tk.Tk):
    ...
    def _build_runner(self, parent):
        ...
        self.btn_judge = flat_button(btns, "⚖ LLM Judge 실행\n보고서o", self._run_judge, color=C["yellow"])
        self.btn_judge.pack(side="left", padx=4)
        ...
        tk.Label(f, text="※ 위 버튼들은 모두 미리 정의된 '테스트 케이스(Test Case)' 시나리오를 바탕으로 자동 진행됩니다.",
