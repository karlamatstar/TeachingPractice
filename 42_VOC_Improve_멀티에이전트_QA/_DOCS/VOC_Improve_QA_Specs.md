...
결과를 파일로도 남기려면:
```powershell
pytest quality_diagnosis -v | Tee-Object -FilePath _OUTPUT\quality_diagnosis\pytest_result.txt
```
...
Get-Content _OUTPUT\quality_diagnosis\quality_score_report.md
