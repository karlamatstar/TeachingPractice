...
WINDOW_TITLE = "스타일몰 채팅 상담 (Client) - FAIL 데모"
WELCOME_MESSAGE = "트렌디한 쇼핑몰 '스타일몰'에 오신 것을 환영합니다! 무엇이든 물어보세요. (FAIL 데모)"
...
class StyleMallChatClient(QMainWindow):
    ...
    def open_log_file(self):
        ...
        log_file_path = os.path.join(project_root, "_OUTPUT", "fail", "logs", "QA_Result_Log.csv")
...
if __name__ == '__main__':
    print("====================================================")
    print("        스타일몰 챗봇 프로그램 (Client) - FAIL 데모   ")
    print("====================================================")
    print("\n현재 챗봇 프로그램이 실행 중입니다...\n")
    print("[주의]")
