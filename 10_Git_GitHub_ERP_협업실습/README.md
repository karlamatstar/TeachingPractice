...
- 백엔드는 JDK와 Gradle Wrapper, 프론트엔드는 Node.js와 npm 모듈 설치가 필요합니다.
- 백엔드 데이터 연결에는 로컬 MariaDB와 `erp` 데이터베이스 구성이 필요합니다.

## 의존성 설치

- Gradle: `Set-Location "src\backend"; .\gradlew.bat build`
- Node.js: `npm install --prefix "src\frontend"`
