...
REPORT_MD_PATH = PROJECT_ROOT / "_DOCS" / "final_quality_report.md"
LIVE_REPORT_MD_PATH = PROJECT_ROOT / "_DOCS" / "live_quality_report.md"
VALIDATION_REPORT_MD_PATH = REPORTS_DIR / "defects" / "chaos" / "defect_report.md"  # scripts/run_validation_tests.py 생성
PERFORMANCE_REPORT_MD_PATH = PROJECT_ROOT / "_OUTPUT" / "performance" / "performance_report.md"  # scripts/run_performance_tests.py 생성
...
def suggest_next_case_id(cases: list) -> str:
    ...
    # 아카이브(_DOCS/test_cases_archive.md)가 TC-030까지 쓰므로 그 뒤 번호부터 제안해 충돌을 피한다
