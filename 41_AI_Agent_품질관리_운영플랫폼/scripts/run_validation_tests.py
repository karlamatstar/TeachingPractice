...
def run_k6():
    ...
    result_file = PROJECT_ROOT / "_OUTPUT" / "performance" / "chaos_result.json"
...
def create_chaos_defect_report(k6_out, pytest_out):
    ...
    report_dir = PROJECT_ROOT / "_OUTPUT" / "quality" / "defects" / "chaos"
...
현상 파악 후 결함 보고서(_OUTPUT/quality/defects/chaos/defect_report.md)를 작성하고, 
