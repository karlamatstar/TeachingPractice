...
def run_k6_performance(k6_bin, script_path, target_host, results_dir, on_line=None):
    ...
    raw_json_path = results_dir / "raw_latency.jsonl"
...
def parse_and_generate_report(raw_json_path, report_dir, on_line=None):
    """raw_latency.jsonl을 파싱해 performance_report.md를 생성하고 경로(Path)를 반환한다.
...
if __name__ == "__main__":
    ...
    results_dir = PROJECT_ROOT / "_OUTPUT" / "performance"
    report_dir = PROJECT_ROOT / "_OUTPUT" / "quality" / "performance"
